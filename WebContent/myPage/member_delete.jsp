          ...
          <div role="document">
            <div class="modal-content rounded-5 shadow">
              <div class="modal-header p-5 pb-4 border-bottom-0">
                ...
                <h2 class="fw-bold mb-0" style="margin-left: 206px;">탈퇴를 위한 비밀번호 입력</h2>
              </div>
              ...
              <div class="modal-body">
                ...
                <div class="form-group" id="divPasswordCheck">
                    <label for="inputPasswordCheck" class="col-lg-2 control-label">비밀번호</label>
                    <div class="col-lg-10">
                        <input type="password" class="form-control" id="password" name="password" data-rule-required="true" maxlength="30">
                    </div>
                </div>
