        ...
        <div class="container"><!-- 좌우측의 공간 확보 -->
            <form action="">
                ...
                <div class="form-group" id="divPhoneNumber">
                    ...
                    <div class="col-lg-10">
                        <input type="tel" class="form-control onlyNumber" id="phoneNumber" data-rule-required="true" placeholder="-를 포함해서 숫자를 입력해주세요." maxlength="11">
                    </div>
                </div>
